...
def collate_hi(folder1,folder2,lat_target,lon_target,sim_side,do_clustering,tag):
    

    from astropy.io import fits
    file=folder2+'/catalogue_HIs_complete_'+tag+'.fits'
    ...
    results0=glob.glob(folder1+'/*HI*.fits')
    ...
    input_file = open('infile_wrapper_HIs_'+tag+'.ini','w')
...
def collate_sfgs(folder1,folder2,lat_target,lon_target,sim_side,do_clustering,tag):
    ...
    results0=glob.glob(folder1+'/*SFG*.fits')
...
def collate_agns(folder1,folder2,lat_target,lon_target,sim_side,do_clustering,tag):
    ...
    results0=glob.glob(folder1+'/*AGN*.fits')
...
folder1='/home/a.bonaldi/local2/scratch/Bonaldi/Radio_srccnt/runs_continuumX/'
folder2='/home/a.bonaldi/local2/scratch/Bonaldi/Radio_srccnt/runs_continuumX/'
tag='contX1'
...
#collate_hi(folder1,folder2,lat_target,lon_target,sim_side,do_clustering,tag)
